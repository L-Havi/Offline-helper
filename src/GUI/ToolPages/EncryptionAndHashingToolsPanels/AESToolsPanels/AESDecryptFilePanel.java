...
public class AESDecryptFilePanel extends ContentPanelBase {
	...
	JButton chooseFileButton = new TopPanelButton("Choose file to AES decrypt");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == startButton && file != null) {
			...
			JOptionPane.showMessageDialog(null, "Succesfully decrypted file " + file.getAbsolutePath(), "Decrypt text", JOptionPane.INFORMATION_MESSAGE);
			...
			error.setText("Choose a File to decrypt!");
